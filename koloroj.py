...
# and spaced. That naming reuses a label for some near-identical shades, so the
# hex is appended where needed to keep every one of the 256 entries unique.
_NAMES = [
    "black", "maroon", "green", "olive", "navy", "purple #800080", "teal", "silver", "grey",
    "red", "lime", "yellow", "blue", "fuchsia", "aqua", "white", "grey 0", "navy blue",
    "dark blue", "blue 3 #0000af", "blue 3 #0000d7", "blue 1", "dark green",
    "deep sky blue 4 #005f5f", "deep sky blue 4 #005f87", "deep sky blue 4 #005faf",
    "dodger blue 3", "dodger blue 2", "green 4", "spring green 4", "turquoise 4",
    "deep sky blue 3 #0087af", "deep sky blue 3 #0087d7", "dodger blue 1", "green 3 #00af00",
    "spring green 3 #00af5f", "dark cyan", "light sea green", "deep sky blue 2",
    "deep sky blue 1", "green 3 #00d700", "spring green 3 #00d75f", "spring green 2 #00d787",
    "cyan 3", "dark turquoise", "turquoise 2", "green 1", "spring green 2 #00ff5f",
    "spring green 1", "medium spring green", "cyan 2", "cyan 1", "dark red #5f0000",
    "deep pink 4 #5f005f", "purple 4 #5f0087", "purple 4 #5f00af", "purple 3", "blue violet",
    "orange 4 #5f5f00", "grey 37", "medium purple 4", "slate blue 3 #5f5faf",
    "slate blue 3 #5f5fd7", "royal blue 1", "chartreuse 4", "dark sea green 4 #5f875f",
    "pale turquoise 4", "steel blue", "steel blue 3", "cornflower blue",
    "chartreuse 3 #5faf00", "dark sea green 4 #5faf5f", "cadet blue #5faf87",
    "cadet blue #5fafaf", "sky blue 3", "steel blue 1 #5fafff", "chartreuse 3 #5fd700",
    "pale green 3 #5fd75f", "sea green 3", "aquamarine 3", "medium turquoise",
    "steel blue 1 #5fd7ff", "chartreuse 2 #5fff00", "sea green 2", "sea green 1 #5fff87",
    "sea green 1 #5fffaf", "aquamarine 1 #5fffd7", "dark slate gray 2", "dark red #870000",
    "deep pink 4 #87005f", "dark magenta #870087", "dark magenta #8700af",
    "dark violet #8700d7", "purple #8700ff", "orange 4 #875f00", "light pink 4", "plum 4",
    "medium purple 3 #875faf", "medium purple 3 #875fd7", "slate blue 1", "yellow 4 #878700",
    "wheat 4", "grey 53", "light slate grey", "medium purple", "light slate blue",
    "yellow 4 #87af00", "dark olive green 3 #87af5f", "dark sea green",
    "light sky blue 3 #87afaf", "light sky blue 3 #87afd7", "sky blue 2",
    "chartreuse 2 #87d700", "dark olive green 3 #87d75f", "pale green 3 #87d787",
    "dark sea green 3 #87d7af", "dark slate gray 3", "sky blue 1", "chartreuse 1",
    "light green #87ff5f", "light green #87ff87", "pale green 1 #87ffaf",
    "aquamarine 1 #87ffd7", "dark slate gray 1", "red 3 #af0000", "deep pink 4 #af005f",
    "medium violet red", "magenta 3 #af00af", "dark violet #af00d7", "purple #af00ff",
    "dark orange 3 #af5f00", "indian red #af5f5f", "hot pink 3 #af5f87", "medium orchid 3",
    "medium orchid", "medium purple 2 #af5fff", "dark goldenrod", "light salmon 3 #af875f",
    "rosy brown", "grey 63", "medium purple 2 #af87d7", "medium purple 1", "gold 3 #afaf00",
    "dark khaki", "navajo white 3", "grey 69", "light steel blue 3", "light steel blue",
    "yellow 3 #afd700", "dark olive green 3 #afd75f", "dark sea green 3 #afd787",
    "dark sea green 2 #afd7af", "light cyan 3", "light sky blue 1", "green yellow",
    "dark olive green 2", "pale green 1 #afff87", "dark sea green 2 #afffaf",
    "dark sea green 1 #afffd7", "pale turquoise 1", "red 3 #d70000", "deep pink 3 #d7005f",
    "deep pink 3 #d70087", "magenta 3 #d700af", "magenta 3 #d700d7", "magenta 2 #d700ff",
    "dark orange 3 #d75f00", "indian red #d75f5f", "hot pink 3 #d75f87", "hot pink 2",
    "orchid", "medium orchid 1 #d75fff", "orange 3", "light salmon 3 #d7875f", "light pink 3",
    "pink 3", "plum 3", "violet", "gold 3 #d7af00", "light goldenrod 3", "tan", "misty rose 3",
    "thistle 3", "plum 2", "yellow 3 #d7d700", "khaki 3", "light goldenrod 2 #d7d787",
    "light yellow 3", "grey 84", "light steel blue 1", "yellow 2",
    "dark olive green 1 #d7ff5f", "dark olive green 1 #d7ff87", "dark sea green 1 #d7ffaf",
    "honeydew 2", "light cyan 1", "red 1", "deep pink 2", "deep pink 1 #ff0087",
    "deep pink 1 #ff00af", "magenta 2 #ff00d7", "magenta 1", "orange red 1",
    "indian red 1 #ff5f5f", "indian red 1 #ff5f87", "hot pink #ff5faf", "hot pink #ff5fd7",
    "medium orchid 1 #ff5fff", "dark orange", "salmon 1", "light coral", "pale violet red 1",
    "orchid 2", "orchid 1", "orange 1", "sandy brown", "light salmon 1", "light pink 1",
    "pink 1", "plum 1", "gold 1", "light goldenrod 2 #ffd75f", "light goldenrod 2 #ffd787",
    "navajo white 1", "misty rose 1", "thistle 1", "yellow 1", "light goldenrod 1", "khaki 1",
    "wheat 1", "cornsilk 1", "grey 100", "grey 3", "grey 7", "grey 11", "grey 15", "grey 19",
    "grey 23", "grey 27", "grey 30", "grey 35", "grey 39", "grey 42", "grey 46", "grey 50",
    "grey 54", "grey 58", "grey 62", "grey 66", "grey 70", "grey 74", "grey 78", "grey 82",
    "grey 85", "grey 89", "grey 93",
]
